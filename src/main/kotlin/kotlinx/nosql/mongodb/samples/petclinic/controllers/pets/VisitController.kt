...
@Controller @RequestMapping(value = "/visits")
class VisitController @Autowired constructor (val db: MongoDB) {
    @RequestMapping(value = "/add", method = arrayOf(RequestMethod.GET))
    fun add(@RequestParam("petId") petIdParam: String, model: Model): String {
        db.withSession {
